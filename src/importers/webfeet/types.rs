...
pub enum Style {
    ...
    DanceEuropean,
    #[serde(rename = "Dance.Family Ceilidh")]
    DanceFamilyCeilidh,
    #[serde(rename = "Dance.Folk Dance")]
    DanceFolkDance,
    #[serde(rename = "Dance.French & Breton")]
    DanceFrenchAndBreton,
    #[serde(rename = "Dance.French/Breton")]
    DanceFrenchBreton,
    ...
    DanceEnglishFolk,
    #[serde(rename = "Dance.French")]
    DanceFrench,
    #[serde(rename = "Dance.French & English")]
    DanceFrenchAndEnglish,

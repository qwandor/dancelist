...
impl IcalendarSource for Cdss {
    const URLS: &'static [&'static str] = &[
        ...
        "https://cdss.org/events/list/page/15/?ical=1",
    ...
    fn workshop(parts: &EventParts) -> bool {
        ...
        summary_lower.contains("class")
            ...
            || description_lower.contains("basics for new folks")
            ...
            || description_lower.contains("beginner instruction")
            ...
            || description_lower.contains("orientation session")
            || description_lower.contains("refresher session")
            || description_lower.contains("review of contra dance basics")
...
fn apply_fixes(event: &mut Event) {
    ...
    match event.name.as_str() {
        ...
        "Annapolis Contra Dance: delightful live music, excellent callers and friendly community" =>
        {
            event.name = "Annapolis Contra Dance".to_string();
        }
        ...
        "Carrboro First Saturday Contra Dance" => {
            event
                .links
                .insert(0, "https://firstsaturdaycontra.com/".to_string());
        }
        "CDK Contra Dance"
        ...
        "English Country Dance in Norwich, VT" => {
            ...
            event.links.insert(
                0,
                "https://davidmillstonedance.com/davids-dance-calendar/".to_string(),
            );
        }
        ...
        | "Lambertville Country Dancers (English Country Dance in Princeton, NJ)" => {
        ...
        "Seacoast Contra Dance" => {
            event
                .links
                .insert(0, "https://seacoastcontra.com/".to_string());
        }
